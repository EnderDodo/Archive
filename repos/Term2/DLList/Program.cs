...
namespace DLList
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string[] alphabet = { "the", "fox", "jumps", "over", "the", "dog" };

            for (int i = 0; i < n; i++)
            {
                words[i] = alphabet[rand.Next(6)];
            }
            ...
            sw.Stop();
            Console.WriteLine("DefaultList: " + sw.Elapsed.TotalMilliseconds);
            ...
            sw.Stop();
            Console.WriteLine("MyList: " + sw.Elapsed.TotalMilliseconds);
